...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
            <a href="javascript:;" onclick="category_add('添加类别','/admin/category_add','','510')" class="btn btn-primary radius">
            ...
            <tr class="text-c">
                ...
                <td>
                    @if($category->preview != null)
                        <img src="{{$category->preview}}" alt="" style="height: 50px;width: 50px;">
                    @endif
                </td>
                <td class="td-manage">
